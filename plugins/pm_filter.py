...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            await query.message.edit(text="<b>Developer : <a href='https://t.me/Amani_m_h_d'>Amani Muhammed</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nSource Code : <a href='https://t.me/nokkiirunnoippokittum'>Click here</a>\nUpdate Channel : <a href='https://t.me/my_test_botz'>Botz Hub</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('More Bots 🤖', url='https://t.me/my_test_botz/47'),
                        InlineKeyboardButton('📜 Update Channel', url='https://t.me/my_test_botz')
                    ]
                    ]
